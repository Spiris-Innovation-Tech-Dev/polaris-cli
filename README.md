...
Rust workspace providing an API library crate and CLI client for the [BlackDuck Coverity on Polaris](https://visma.cop.blackduck.com) platform. Query projects, browse issues with source code context, manage triage — all from the terminal.
...
| `POLARIS_BASE_URL` | `--base-url` | `https://visma.cop.blackduck.com` | Polaris instance URL |
...
First detected: -
URL:            https://visma.cop.blackduck.com/projects/.../issues/...?pagingOffset=0&path=...
...
async fn main() -> Result<(), Box<dyn std::error::Error>> {
    let config = PolarisConfig {
        base_url: "https://visma.cop.blackduck.com".into(),
